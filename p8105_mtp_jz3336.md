...
the serial number observations to date class. Next, I put all dog names
and the “std” representing standard objects into the
...
the “date” variable resulted from an “s” entry in “date” in the raw
dataset. Thus, I chose to also drop missing values in “date” which
helped me to leave out all NAs associated with the “s” entry. Even
though there were weights recorded on the day “s”, but these weights
value are not meaning for data analysis without the associate date.
...
is consists of 3 variables and 550 observations. The variables are
“date”, “dognames\_and\_std”, and “weights\_in\_lbs”. The “note”
column in the raw dataset was omitted in the dogweights\_df.
